    ...
    <div className="min-h-screen">
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start text-sm text-gray-700">
                        <div className="mr-2 mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-orange-600" />
                        {feature}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="bg-gradient-to-r from-orange-600 to-orange-700 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-xl text-orange-100">{dict.services.urgentDescription}</p>
