...
const dictionaries: Record<Locale, Dictionary> = {
  vi: {
    ...
    common: {
      companyTagline: 'Tư vấn và xúc tiến đầu tư bất động sản công nghiệp uy tín tại Việt Nam. 15+ năm kinh nghiệm.',
    ...
    home: {
      heroTitle: 'Bất Động Sản Công Nghiệp',
      heroAccent: 'Uy Tín & Hiệu Quả',
      heroDescription: 'Tư vấn và xúc tiến đầu tư bất động sản công nghiệp chuyên nghiệp tại Việt Nam. 15+ năm kinh nghiệm.',
      ...
      featuredDescription: 'Các cơ hội đầu tư bất động sản công nghiệp hấp dẫn nhất',
      viewAll: 'Xem tất cả',
      whyTitle: 'Tại sao chọn Macland?',
    ...
    about: {
      ...
      introTitle: 'Lời ngỏ',
      introParagraphs: [
        'Macland là đơn vị uy tín trong lĩnh vực tư vấn và xúc tiến đầu tư bất động sản công nghiệp tại Việt Nam. Với hơn 15 năm kinh nghiệm, chúng tôi tự hào đã đồng hành cùng hàng nghìn nhà đầu tư trong và ngoài nước tìm kiếm cơ hội đầu tư thành công.',
        'Chúng tôi hiểu rằng mỗi quyết định đầu tư là một bước đi quan trọng. Do đó, Macland cam kết mang lại giải pháp toàn diện, từ tư vấn chiến lược, hỗ trợ pháp lý đến quản lý đầu tư, giúp khách hàng tối đa hóa hiệu quả và giảm thiểu rủi ro.',
        'Với mạng lưới đối tác rộng khắp và am hiểu sâu sắc về thị trường bất động sản công nghiệp Việt Nam, Macland sẵn sàng trở thành người bạn đồng hành tin cậy trên hành trình đầu tư của bạn.',
      ],
      valuesTitle: 'Giá trị cốt lõi',
      valuesDescription: 'Những giá trị định hình nên văn hóa và cách thức làm việc của Macland',
      stats: [
    ...
    chatbot: {
      ...
      formTitle: 'Để lại thông tin để MACLAND liên hệ lại',
      submit: 'Gửi thông tin',
      teaser: 'Chat với MACLAND để gửi thông tin tư vấn nhanh.',
      open: 'Mở form tư vấn',
      close: 'Đóng cửa sổ',
    },
  },
  en: {
    metadata: {
      title: 'Macland - Industrial Real Estate',
    ...
    about: {
      ...
      introParagraphs: [
        'Macland is a trusted advisory firm specializing in industrial real estate investment facilitation in Vietnam. With more than 15 years of experience, we have supported thousands of local and international investors in finding the right opportunities.',
        'We understand that every investment decision matters. Macland is committed to providing end-to-end solutions, from strategic advisory and legal support to investment execution, helping clients maximize efficiency and reduce risk.',
        'With a broad partner network and deep understanding of Vietnam’s industrial property market, Macland is ready to be a dependable partner throughout your investment journey.',
      ],
      valuesTitle: 'Core values',
      valuesDescription: 'The principles that shape how Macland works with investors and partners',
      stats: [
    ...
    chatbot: {
      ...
      formTitle: 'Leave your details and MACLAND will contact you',
      submit: 'Submit information',
      teaser: 'Chat with MACLAND to send your consultation request quickly.',
  ...
  zh: {
    ...
    about: {
      ...
      introTitle: '公司介绍',
      introParagraphs: [
        'Macland 专注于越南工业地产投资咨询与落地服务。凭借 15 年以上经验，我们已协助众多本地与国际投资者找到合适的进入机会。',
        '我们深知每一个投资决策都很关键，因此 Macland 提供从战略咨询、法律支持到投资执行的一体化服务，帮助客户提升效率并降低风险。',
        '依托广泛合作网络与对越南工业地产市场的深入理解，Macland 愿成为您长期可靠的合作伙伴。',
      ],
      valuesTitle: '核心价值',
      valuesDescription: '塑造 Macland 工作方式与服务标准的基本原则',
      stats: [
        { value: '15+', label: '年经验' },
    ...
    chatbot: {
      ...
      title: '快速咨询',
      panelTitle: '快速咨询',
      formTitle: '留下您的信息，MACLAND 将尽快联系您',
      submit: '提交信息',
      teaser: '与 MACLAND 聊天，快速发送咨询需求。',
      open: '打开咨询表单',
      close: '关闭窗口',
    },
  },
  ko: {
    ...
    about: {
      ...
      introTitle: '소개',
      introParagraphs: [
        'Macland는 베트남 산업용 부동산 투자 자문 및 진출 지원을 전문으로 하는 신뢰할 수 있는 기업입니다. 15년 이상의 경험을 바탕으로 국내외 투자자들의 적합한 진입 기회를 지원해 왔습니다.',
        '모든 투자 결정이 중요하다는 점을 잘 알고 있습니다. Macland는 전략 자문, 법률 지원, 투자 실행까지 일관된 솔루션을 제공하여 고객의 효율을 높이고 리스크를 줄입니다.',
        '폭넓은 파트너 네트워크와 베트남 산업용 부동산 시장에 대한 깊은 이해를 기반으로 Macland는 장기적인 파트너가 될 준비가 되어 있습니다.',
      ],
      valuesTitle: '핵심 가치',
      valuesDescription: 'Macland의 업무 방식과 서비스 기준을 만드는 원칙',
      stats: [
    ...
    chatbot: {
      ...
      title: '빠른 상담',
      panelTitle: '빠른 상담',
      formTitle: '정보를 남겨주시면 MACLAND가 연락드리겠습니다',
      submit: '정보 제출',
      teaser: 'MACLAND와 채팅하여 빠르게 상담 요청을 보내세요.',
      open: '상담 폼 열기',
      close: '패널 닫기',
    },
  },
  ja: {
    ...
    about: {
      ...
      introTitle: 'ご挨拶',
      introParagraphs: [
        'Macland は、ベトナムにおける工業不動産投資支援を専門とする信頼性の高いアドバイザリーファームです。15年以上の経験をもとに、多くの国内外投資家の進出を支援してきました。',
        '私たちは、あらゆる投資判断が重要であることを理解しています。そのため、戦略策定、法務支援、実行支援までを一体で提供し、効率向上とリスク低減を支援します。',
        '幅広いパートナーネットワークとベトナム工業不動産市場への深い理解を活かし、Macland は長期的な信頼できるパートナーとして伴走します。',
      ],
      valuesTitle: 'コアバリュー',
      valuesDescription: 'Macland の仕事の進め方と品質基準を形づくる原則',
      stats: [
        { value: '15+', label: '経験年数' },
    ...
    chatbot: {
      ...
      title: 'クイック相談',
      panelTitle: 'クイック相談',
      formTitle: '情報を残していただければ MACLAND からご連絡します',
      submit: '情報を送信',
      teaser: 'MACLAND とチャットして素早く相談内容を送信できます。',
      open: '相談フォームを開く',
      close: '閉じる',
    },
  },
